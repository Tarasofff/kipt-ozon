...
// //TODO rename
// const inputFields: Record<keyof PatientsFilterFields, InputFieldConfig> = {
//   is_active: {
//     element: 'select',
//     options: [
...
//         const config = inputFields[field as keyof PatientsFilterFields];
...
const PatientsFilterPanel: React.FC<PatientsFilterPanelProps> = React.memo(({ fields }) => {
  ...
  return (
    <Form
      ...
      formFields={fields}
      onChange={setFilters}
      keyboardNavigation={() => handleSearch(queryParams)}
      children={btns}
    />
  );
});
